...
content: 在关系型数据库中设计索引其实并不是复杂的事情，很多开发者都觉得设计索引能够提升数据库的性能，相关的知识一定非常复杂，然而这种想法是不正确的，索引其实并不是一个多么高深莫测的东西，只要我们掌握一定的方法，理解索引的实现就能在不需要 DBA 的情况下设计出高效的索引。
---

在关系型数据库中设计索引其实并不是复杂的事情，很多开发者都觉得设计索引能够提升数据库的性能，相关的知识一定非常复杂。

![Index-and-Performance](http://img.draveness.me/2017-09-11-Index-and-Performance.jpg)
...
![Disk-IO](http://img.draveness.me/2017-09-11-Disk-IO.jpg)

除此之外，我们还需要知道数据库对数据的读取并不是以行为单位进行的，无论是读取一行还是多行，都会将该行或者多行所在的页全部加载进来，然后再读取对应的数据记录；也就是说，读取所耗费的时间与行数无关，只与页数有关。

![Page-DatabaseBufferPool](http://img.draveness.me/2017-09-11-Page-DatabaseBufferPool.jpg)
...
![Disk-Random-IO](http://img.draveness.me/2017-09-11-Disk-Random-IO.jpg)
...
![Disk-IO-Total-Time](http://img.draveness.me/2017-09-11-Disk-IO-Total-Time.jpg)
...
![Read-from-Memory](http://img.draveness.me/2017-09-11-Read-from-Memory.jpg)
...
![Sequential-Reads-from-Disk](http://img.draveness.me/2017-09-11-Sequential-Reads-from-Disk.jpg)

如果一个页面的大小为 4KB，那么 1s 的时间就可以读取 10000 个页，读取一个页面所花费的平均时间就是 0.1ms，相比随机读取的 10ms 已经降低了两个数量级，甚至比内存中读取数据还要快。

![Random-to-Sequentia](http://img.draveness.me/2017-09-11-Random-to-Sequential.jpg)
...
![Thin-Index-and-Fat-Index](http://img.draveness.me/2017-09-11-Thin-Index-and-Fat-Index.jpg)
...
![Thin-Index-and-Clustered-Index](http://img.draveness.me/2017-09-11-Thin-Index-and-Clustered-Index.jpg)
...
![Filter-Facto](http://img.draveness.me/2017-09-11-Filter-Factor.jpg)
...
![Combined-Filter-Facto](http://img.draveness.me/2017-09-11-Combined-Filter-Factor.jpg)
...
![Same-Columns-Filter-Facto](http://img.draveness.me/2017-09-11-Same-Columns-Filter-Factor.jpg)
...
![Match-Columns-Filter-Columns](http://img.draveness.me/2017-09-11-Match-Columns-Filter-Columns.jpg)
...
![Three-Star-Index](http://img.draveness.me/2017-09-11-Three-Star-Index.jpg)
...
![Behind-Three-Star-Index](http://img.draveness.me/2017-09-11-Behind-Three-Star-Index.jpg)
...
![Different-Stars-Index](http://img.draveness.me/2017-09-11-Different-Stars-Index.jpg)
