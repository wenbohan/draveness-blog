...
![out-of-contro](http://img.draveness.me/2017-01-30-out-of-control.jpg)
...
![RACSignal-Hierachy](http://img.draveness.me/2017-01-30-RACSignal-Hierachy.png)

`RACSignal` 可以说是 ReactiveCocoa 中的核心类，也是最重要的概念，整个框架围绕着 `RACSignal` 的概念进行组织，对 `RACSignal` 最简单的理解就是它表示一连串的状态：

![What-is-RACSigna](http://img.draveness.me/2017-01-30-What-is-RACSignal.png)
...
![RACStream-AbstractMethod](http://img.draveness.me/2017-01-30-RACStream-AbstractMethod.png)
...
![RACStream-Operation](http://img.draveness.me/2017-01-30-RACStream-Operation.png)
...
![RACSignal-Return](http://img.draveness.me/2017-01-30-RACSignal-Return.png)
...
![RACSignal-Bind](http://img.draveness.me/2017-01-30-RACSignal-Bind.png)
...
![Before-After-Bind-RACSigna](http://img.draveness.me/2017-01-30-Before-After-Bind-RACSignal.png)
...
![Before-After-Bind-RACSignal-Complicated](http://img.draveness.me/2017-01-30-Before-After-Bind-RACSignal-Complicated.png)
...
![RACSignal-Subclasses](http://img.draveness.me/2017-01-30-RACSignal-Subclasses.png)

其实这几种子类并没有对原有的 `RACSignal` 做出太大的改变，它们的创建过程也不是特别的复杂，只需要调用 `RACSignal` 不同的类方法：

![RACSignal-Instantiate-Object](http://img.draveness.me/2017-01-30-RACSignal-Instantiate-Object.png)
...
![RACSignal-Subcribe-Process](http://img.draveness.me/2017-01-30-RACSignal-Subcribe-Process.png)
...
![RACSignal-Subscribe-Methods](http://img.draveness.me/2017-01-30-RACSignal-Subscribe-Methods.png)
...
![Principle-of-Subscribing-Signals](http://img.draveness.me/2017-01-30-Principle-of-Subscribing-Signals.png)

### 信息的发送

在 `RACSignalBindBlock` 中，订阅者可以根据自己的兴趣选择自己想要订阅哪种消息；我们也可以按需发送三种消息：

![RACSignal-Subcription-Messages-Sending](http://img.draveness.me/2017-01-30-RACSignal-Subcription-Messages-Sending.png)
...
![RACDisposable-And-Subclasses](http://img.draveness.me/2017-01-30-RACDisposable-And-Subclasses.png)
...
![RACDisposable](http://img.draveness.me/2017-01-30-RACDisposable.png)
...
![RACCompoundDisposable](http://img.draveness.me/2017-01-30-RACCompoundDisposable.png)
...
![RACSignal-Bind-Disposable](http://img.draveness.me/2017-01-30-RACSignal-Bind-Disposable.png)
