...
![out-of-contro](http://img.draveness.me/2017-01-30-out-of-control.jpg-1000width)
...
![RACSignal-Hierachy](http://img.draveness.me/2017-01-30-RACSignal-Hierachy.png-1000width)

`RACSignal` 可以说是 ReactiveCocoa 中的核心类，也是最重要的概念，整个框架围绕着 `RACSignal` 的概念进行组织，对 `RACSignal` 最简单的理解就是它表示一连串的状态：

![What-is-RACSigna](http://img.draveness.me/2017-01-30-What-is-RACSignal.png-1000width)
...
![RACStream-AbstractMethod](http://img.draveness.me/2017-01-30-RACStream-AbstractMethod.png-1000width)
...
![RACStream-Operation](http://img.draveness.me/2017-01-30-RACStream-Operation.png-1000width)
...
![RACSignal-Return](http://img.draveness.me/2017-01-30-RACSignal-Return.png-1000width)
...
![RACSignal-Bind](http://img.draveness.me/2017-01-30-RACSignal-Bind.png-1000width)
...
![Before-After-Bind-RACSigna](http://img.draveness.me/2017-01-30-Before-After-Bind-RACSignal.png-1000width)
...
![Before-After-Bind-RACSignal-Complicated](http://img.draveness.me/2017-01-30-Before-After-Bind-RACSignal-Complicated.png-1000width)
...
![RACSignal-Subclasses](http://img.draveness.me/2017-01-30-RACSignal-Subclasses.png-1000width)

其实这几种子类并没有对原有的 `RACSignal` 做出太大的改变，它们的创建过程也不是特别的复杂，只需要调用 `RACSignal` 不同的类方法：

![RACSignal-Instantiate-Object](http://img.draveness.me/2017-01-30-RACSignal-Instantiate-Object.png-1000width)
...
![RACSignal-Subcribe-Process](http://img.draveness.me/2017-01-30-RACSignal-Subcribe-Process.png-1000width)
...
![RACSignal-Subscribe-Methods](http://img.draveness.me/2017-01-30-RACSignal-Subscribe-Methods.png-1000width)
...
![Principle-of-Subscribing-Signals](http://img.draveness.me/2017-01-30-Principle-of-Subscribing-Signals.png-1000width)

### 信息的发送

在 `RACSignalBindBlock` 中，订阅者可以根据自己的兴趣选择自己想要订阅哪种消息；我们也可以按需发送三种消息：

![RACSignal-Subcription-Messages-Sending](http://img.draveness.me/2017-01-30-RACSignal-Subcription-Messages-Sending.png-1000width)
...
![RACDisposable-And-Subclasses](http://img.draveness.me/2017-01-30-RACDisposable-And-Subclasses.png-1000width)
...
![RACDisposable](http://img.draveness.me/2017-01-30-RACDisposable.png-1000width)
...
![RACCompoundDisposable](http://img.draveness.me/2017-01-30-RACCompoundDisposable.png-1000width)
...
![RACSignal-Bind-Disposable](http://img.draveness.me/2017-01-30-RACSignal-Bind-Disposable.png-1000width)
