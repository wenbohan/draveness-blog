...
![Dynamic-Stati](http://img.draveness.me/Dynamic-Static.png)
...
![MVCS-Architecture](http://img.draveness.me/MVCS-Architecture.png)
...
![Abstract-Request](http://img.draveness.me/Abstract-Request.jpg)
...
![Manager-And-Request](http://img.draveness.me/Manager-And-Request.jpg)
...
![Model-And-Dictioanry](http://img.draveness.me/Model-And-Dictioanry.jpg)

单独的 Model 层并不能返回什么关键的作用，它只有与网络服务层 Service 结合在一起的时候才能发挥更重要的能力。

![Service-And-API](http://img.draveness.me/Service-And-API.jpg)
...
![Server-MV](http://img.draveness.me/Server-MVC.jpg)
...
![Relation-Between-Database-And-Mode](http://img.draveness.me/Relation-Between-Database-And-Model.jpg)
...
![web-black-box](http://img.draveness.me/web-black-box.jpg)

在服务端拿到数据后对其进行处理、加工以及存储，最后仍然以数据的形式返回给用户。

而客户端重展示，其输入就是用户的行为触发的事件，而输出是用户界面：

![client-black-box](http://img.draveness.me/client-black-box.jpg)
...
![Model-in-Client](http://img.draveness.me/Model-in-Client.jpg)
...
![JSON-Mode](http://img.draveness.me/JSON-Model.jpg)
