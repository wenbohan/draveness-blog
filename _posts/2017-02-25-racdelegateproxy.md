...
![Delegate-To-RACSigna](http://img.draveness.me/2017-02-25-Delegate-To-RACSignal.png-800width)
...
![RACDelegateProxy](http://img.draveness.me/2017-02-25-RACDelegateProxy.png-800width)
...
![UITableViewDelegate-With-RACDelegateProxy](http://img.draveness.me/2017-02-25-UITableViewDelegate-With-RACDelegateProxy.png-800width)
...
![Message-Forwarding](http://img.draveness.me/2017-02-25-Message-Forwarding.png-800width)
...
![NSObjectRACSignalForSelecto](http://img.draveness.me/2017-02-25-NSObjectRACSignalForSelector.png-800width)
...
![Swizzle-objc_msgForward](http://img.draveness.me/2017-02-25-Swizzle-objc_msgForward.png-800width)
...
![TypeEncoding](http://img.draveness.me/2017-02-25-TypeEncoding.png-800width)

生成了类型编码之后，由于我们并没有在当前类中找到该选择子对应的方法，所以会使用 `class_addMethod` 为当前类提供一个方法的实现，直接将当前选择子的实现改为 `_objc_msgForward`。

![Selector-To-ObjC-Message-Forward](http://img.draveness.me/2017-02-25-Selector-To-ObjC-Message-Forward.png-800width)
...
![Selector-To-ObjC-Message-Forward-With-RACSelecto](http://img.draveness.me/2017-02-25-Selector-To-ObjC-Message-Forward-With-RACSelector.png-800width)
...
![Selector-To-IMP](http://img.draveness.me/2017-02-25-Selector-To-IMP.png-800width)

与正常的方法实现查找以及执行过程的简单不同，如果我们对某一个方法调用了 `-rac_signalForSelector:` 方法，那么对于同一个对象对应的类的所有方法，它们的执行过程会变得非常复杂：

![After-Call-RACSignalForSelecto](http://img.draveness.me/2017-02-25-After-Call-RACSignalForSelector.png-800width)
