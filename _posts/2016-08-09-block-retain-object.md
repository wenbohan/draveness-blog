...
![block-superclass](http://img.draveness.me/2016-08-05-block-superclass.png-1000width)
...
![block-capture-var-layout](http://img.draveness.me/2016-08-05-block-capture-var-layout.png-1000width)
...
![block-capture-strong-weak-orde](http://img.draveness.me/2016-08-05-block-capture-strong-weak-order.png-1000width)
...
![before-dispose-helpe](http://img.draveness.me/2016-08-05-before-dispose-helper.jpeg)

`obj` 数组中的每一个位置都存储了 `FBBlockStrongRelationDetector` 的实例，但是在 `dispose_helper` 调用之后：

![after-dispose-helpe](http://img.draveness.me/2016-08-05-after-dispose-helper.png-1000width)
