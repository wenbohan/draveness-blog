...
cover: http://img.draveness.me/2017-09-06-MongoDB-Covers.jpg
content: MongoDB 是目前主流的 NoSQL 数据库之一，与关系型数据库和其它的 NoSQL 不同，MongoDB 使用了面向文档的数据存储方式，将数据以类似 JSON 的方式存储在磁盘上，因为项目上的一些历史遗留问题，作者在最近的工作中也不得不经常与 MongoDB 打交道，这也是这篇文章出现的原因。
---
...
![logo](http://img.draveness.me/2017-09-06-logo.png)
...
![its-not-always-simple-banner](http://img.draveness.me/2017-09-06-its-not-always-simple-banner.jpg)

### 架构

现有流行的数据库其实都有着非常相似的架构，MongoDB 其实就与 MySQL 中的架构相差不多，底层都使用了『可插拔』的存储引擎以满足用户的不同需要。

![MongoDB-Architecture](http://img.draveness.me/2017-09-06-MongoDB-Architecture.jpg)
...
![Translating-Between-RDBMS-and-MongoDB](http://img.draveness.me/2017-09-06-Translating-Between-RDBMS-and-MongoDB.jpg)
...
![Different-Data-Structure](http://img.draveness.me/2017-09-06-Different-Data-Structure.jpg)
...
![Reference-MongoDB](http://img.draveness.me/2017-09-06-Reference-MongoDB.jpg)
...
![Not-Found-Document](http://img.draveness.me/2017-09-06-Not-Found-Document.jpg)
...
![Embedded-Data-Models-MongoDB](http://img.draveness.me/2017-09-06-Embedded-Data-Models-MongoDB.jpg)
...
![MongoDB-Indexes](http://img.draveness.me/2017-09-06-MongoDB-Indexes.jpg)
...
![MongoDB-ObjectId](http://img.draveness.me/2017-09-06-MongoDB-ObjectId.jpg)
...
![Single-Field-Index](http://img.draveness.me/2017-09-06-Single-Field-Index.jpg)
...
![Compound-Index](http://img.draveness.me/2017-09-06-Compound-Index.jpg)
...
![Multiple-Storage-Engines](http://img.draveness.me/2017-09-06-Multiple-Storage-Engines.jpg)

### WiredTiger

MongoDB3.2 之后 WiredTiger 就是默认的存储引擎了，如果对各个存储引擎并不了解，那么还是不要改变 MongoDB 的默认存储引擎；它有着非常多的优点，比如拥有效率非常高的缓存机制：

![WiredTiger-Cache](http://img.draveness.me/2017-09-06-WiredTiger-Cache.jpg)
...
![Checkpoints-Conditions](http://img.draveness.me/2017-09-06-Checkpoints-Conditions.jpg)
