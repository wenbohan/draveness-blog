...
permalink: /sdeikiq.html
tags: Sidekiq Ruby Redis MQ Rails Server
cover: http://img.draveness.me/2017-08-28-Sidekiq-Cover.jpg
content: Sidekiq 是 Ruby 和 Rails 项目中常用的后台任务处理系统，其本身提供的 API 十分简洁，源代码也非常易于阅读，是一个轻量级的异步处理组件；虽然其本身没有提供太多复杂的功能，但是它的使用和部署非常简单。在这篇文章中，我们将对 Sidekiq 的实现原理进行介绍和分析。
---
...
![Sidekiq-Cover](http://img.draveness.me/2017-08-28-Sidekiq-Cover.jpg)
...
![Sidekiq-Arch](http://img.draveness.me/2017-08-28-Sidekiq-Arch.jpg)
...
![Client-Push-Item](http://img.draveness.me/2017-08-28-Client-Push-Item.jpg)
...
![Async-Schedule](http://img.draveness.me/2017-08-28-Async-Schedule.jpg)
...
![Perform-async-in-Redis](http://img.draveness.me/2017-08-28-Perform-async-in-Redis.jpg)

所有的 `payload` 中都包含了一个异步任务需要执行的全部信息，包括该任务的执行的队列 `queue`、异步队列的类 `class`、参数 `args` 以及 `sidekiq_options` 中的全部参数。

![Job-in-Redis](http://img.draveness.me/2017-08-28-Job-in-Redis.jpg)
...
![Launcher-Poller-Manager-Processors](http://img.draveness.me/2017-08-28-Launcher-Poller-Manager-Processors.jpg)
...
![Sidekiq-Multi-Processes](http://img.draveness.me/2017-08-28-Sidekiq-Multi-Processes.jpg)
...
![Redis-Sorted-Set](http://img.draveness.me/2017-08-28-Redis-Sorted-Set.jpg)
...
![Redis-Sidekiq-Poller](http://img.draveness.me/2017-08-28-Redis-Sidekiq-Poller.jpg)
...
![Client-Redis-Sidekiq-Worker](http://img.draveness.me/2017-08-28-Client-Redis-Sidekiq-Worker.jpg)
...
![Middlewares-Client-Redis-Sidekiq-Worker](http://img.draveness.me/2017-08-28-Middlewares-Client-Redis-Sidekiq-Worker.jpg)
...
![Sidekiq-Middlewares](http://img.draveness.me/2017-08-28-Sidekiq-Middlewares.jpg)
