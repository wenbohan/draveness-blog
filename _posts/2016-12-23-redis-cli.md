...
![redis-client-serve](http://img.draveness.me/2016-12-23-redis-client-server.jpg-1000width)
...
![redis-resp-data-byte](http://img.draveness.me/2016-12-23-redis-resp-data-byte.jpg-1000width)

举一个简单的例子，字符串 `OK` 以及错误`Error Message` 等不同种类的信息的 RESP 表示如下：

![redis-resp-type-and-examples](http://img.draveness.me/2016-12-23-redis-resp-type-and-examples.jpg-1000width)
...
![redis-lldb-cmd](http://img.draveness.me/2016-12-23-redis-lldb-cmd.png-1000width)
...
![redis-lldb-nwritten](http://img.draveness.me/2016-12-23-redis-lldb-nwritten.png-1000width)
...
![redis-lldb-read](http://img.draveness.me/2016-12-23-redis-lldb-read.png-1000width)
...
![process-end](http://img.draveness.me/2016-12-23-process-end.png-1000width)
...
![redis-client-process-commands](http://img.draveness.me/2016-12-23-redis-client-process-commands.jpg-1000width)
