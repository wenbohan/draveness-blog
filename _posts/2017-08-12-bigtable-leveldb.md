...
tags: Server LevelDB database
cover: http://img.draveness.me/2017-08-12-Bigtable-LevelDB-Cover.jpg
content: 在 2006 年的 OSDI 上，Google 发布了名为 Bigtable 的论文，其中描述了一个用于管理结构化数据的分布式存储系统  - Bigtable 的数据模型、接口以及实现等内容。本文会先对 Bigtable 一文中描述的分布式存储系统进行简单的描述，然后对 Google 开源的 KV 存储数据库 LevelDB 进行分析；LevelDB 可以理解为单点的 Bigtable 的系统，虽然其中没有 Bigtable 中与 tablet 管理以及一些分布式相关的逻辑，不过我们可以通过对 LevelDB 源代码的阅读增加对 Bigtable 的理解。
---
...
[leveldb-logo](http://img.draveness.me/2017-08-12-leveldb-logo.png)
...
![Goals-of-Bigtable](http://img.draveness.me/2017-08-12-Goals-of-Bigtable.jpg)
...
![Bigtable-DataModel-Row-Column-Timestamp-Value](http://img.draveness.me/2017-08-12-Bigtable-DataModel-Row-Column-Timestamp-Value.jpg)
...
![Tablet-Location-Hierarchy](http://img.draveness.me/2017-08-12-Tablet-Location-Hierarchy.jpg)
...
![Master-Manage-Tablet-Servers-And-Tablets](http://img.draveness.me/2017-08-12-Master-Manage-Tablet-Servers-And-Tablets.jpg)
...
![Tablet-Serving](http://img.draveness.me/2017-08-12-Tablet-Serving.jpg)
...
![Minor-Compaction](http://img.draveness.me/2017-08-12-Minor-Compaction.jpg)
...
![Major-Compaction](http://img.draveness.me/2017-08-12-Major-Compaction.jpg)
...
![LevelDB-Put](http://img.draveness.me/2017-08-12-LevelDB-Put.jpg)
...
![Immutable-MemTable](http://img.draveness.me/2017-08-12-Immutable-MemTable.jpg)

你可以看到，与 Bigtable 中论文不同的是，LevelDB 中引入了一个不可变的 memtable 结构 imm，它的结构与 memtable 完全相同，只是其中的所有数据都是不可变的。

![LevelDB-Serving](http://img.draveness.me/2017-08-12-LevelDB-Serving.jpg)
...
![LevelDB-log-format-and-recordtype](http://img.draveness.me/2017-08-12-LevelDB-log-format-and-recordtype.jpg)
...
![LevelDB-Memtable-Key-Value-Format](http://img.draveness.me/2017-08-12-LevelDB-Memtable-Key-Value-Format.jpg)
...
![LevelDB-MemTable-SkipList](http://img.draveness.me/2017-08-12-LevelDB-MemTable-SkipList.jpg)
...
![LevelDB-Read-Processes](http://img.draveness.me/2017-08-12-LevelDB-Read-Processes.jpg)
...
![FileMetaData](http://img.draveness.me/2017-08-12-FileMetaData.jpg)
...
![LevelDB-Level0-Laye](http://img.draveness.me/2017-08-12-LevelDB-Level0-Layer.jpg)
...
![LevelDB-LevelN-Layers](http://img.draveness.me/2017-08-12-LevelDB-LevelN-Layers.jpg)
...
![LevelDB-BackgroundCompaction-Processes](http://img.draveness.me/2017-08-12-LevelDB-BackgroundCompaction-Processes.jpg)
...
![LevelDB-Pick-Compactions](http://img.draveness.me/2017-08-12-LevelDB-Pick-Compactions.jpg)

LevelDB 中的 `DoCompactionWork` 方法会对所有传入的 SSTable 中的键值使用归并排序进行合并，最后会在高高层级（图中为 Level2）中生成一个新的 SSTable。

![LevelDB-After-Compactions](http://img.draveness.me/2017-08-12-LevelDB-After-Compactions.jpg)
...
![VersionSet-Version-And-VersionEdit](http://img.draveness.me/2017-08-12-VersionSet-Version-And-VersionEdit.jpg)
...
![SSTable-Format](http://img.draveness.me/2017-08-12-SSTable-Format.jpg)

当 LevelDB 读取 SSTable 存在的 `ldb` 文件时，会先读取文件中的 `Footer` 信息。

![SSTable-Foote](http://img.draveness.me/2017-08-12-SSTable-Footer.jpg)
