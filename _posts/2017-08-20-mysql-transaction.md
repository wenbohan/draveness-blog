...
content: 在关系型数据库中，事务的重要性不言而喻，只要对数据库稍有了解的人都知道事务具有 ACID 四个基本属性，而我们不知道的可能就是数据库是如何实现这四个属性的；在这篇文章中，我们将对事务的实现进行分析，尝试理解数据库是如何实现事务的，当然我们也会在文章中简单对 MySQL 中对 ACID 的实现进行简单的介绍。
---
...
![Transaction-Basics](http://img.draveness.me/2017-08-20-Transaction-Basics.jpg)
...
![Atomic-Operation](http://img.draveness.me/2017-08-20-Atomic-Operation.jpg)
...
![Transaction-Undo-Log](http://img.draveness.me/2017-08-20-Transaction-Undo-Log.jpg)
...
![Logical-Undo-Log](http://img.draveness.me/2017-08-20-Logical-Undo-Log.jpg)
...
![Atomitc-Transaction-State](http://img.draveness.me/2017-08-20-Atomitc-Transaction-State.jpg)

但是如果放大来看，我们会发现事务不再是原子的，其中包括了很多中间状态，比如部分提交，事务的状态图也变得越来越复杂。

![Nonatomitc-Transaction-State](http://img.draveness.me/2017-08-20-Nonatomitc-Transaction-State.jpg)
...
![Shutdown-After-Commited](http://img.draveness.me/2017-08-20-Shutdown-After-Commited.jpg)
...
![Nonrecoverable-Schedule](http://img.draveness.me/2017-08-20-Nonrecoverable-Schedule.jpg)
...
![Recoverable-Schedule](http://img.draveness.me/2017-08-20-Recoverable-Schedule.jpg)

然而这样还不算完，当事务的数量逐渐增多时，整个恢复流程也会变得越来越复杂，如果我们想要从事务发生的错误中恢复，也不是一件那么容易的事情。

![Cascading-Rollback](http://img.draveness.me/2017-08-20-Cascading-Rollback.jpg)
...
![Compensating-Transaction](http://img.draveness.me/2017-08-20-Compensating-Transaction.jpg)
...
![Redo-Logging](http://img.draveness.me/2017-08-20-Redo-Logging.jpg)
...
![Transaction-Log](http://img.draveness.me/2017-08-20-Transaction-Log.jpg)
...
![Reasons-for-Allowing-Concurrency](http://img.draveness.me/2017-08-20-Reasons-for-Allowing-Concurrency.jpg)
...
![Isolation-Performance](http://img.draveness.me/2017-08-20-Isolation-Performance.jpg)
...
![Transaction-Isolation-Matrix](http://img.draveness.me/2017-08-20-Transaction-Isolation-Matrix.jpg)
...
![Shared-Exclusive-Lock](http://img.draveness.me/2017-08-20-Shared-Exclusive-Lock.jpg)
...
![Timestamps-Record](http://img.draveness.me/2017-08-20-Timestamps-Record.jpg)
...
![Shared-Lock-and-Atomicity](http://img.draveness.me/2017-08-20-Shared-Lock-and-Atomicity.jpg)
...
![ACID-And-CAP](http://img.draveness.me/2017-08-20-ACID-And-CAP.jpg)
...
![Transaction-Consistency](http://img.draveness.me/2017-08-20-Transaction-Consistency.jpg)
